...
\title{Artifact: {\textmu}Touch: Enabling Accurate, Lightweight Self-Touch Sensing with Passive Magnets}
...
git clone --recurse-submodules \
  git@github.com:Wangmerlyn/muTouch.git
# HTTPS fallback:
# git clone --recurse-submodules \
