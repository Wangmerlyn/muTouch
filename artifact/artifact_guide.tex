...
Due to page limits, this PDF is a concise checklist. For full, continuously updated steps and tips, please refer to the repository \texttt{README.md} and the Markdown guide at \path{artifact/ARTIFACT_GUIDE.md}. Use those as the authoritative references for reproduction and further code tweaks.
